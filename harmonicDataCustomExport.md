...
var Foo = require('users/sobata5632/default:kNN/HarmonicData.js');//Module for this data. 
...
print(rmse)
var outRaster=maximum.addBands([minimum,mean,rmse,tcbH[1]]).rename(["max","min","mean","rmse","amp"])
// //===================================================
